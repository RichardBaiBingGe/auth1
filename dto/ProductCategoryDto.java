...
public class ProductCategoryDto {
	...
	public ProductCategoryDto(String id, Date createDate, Date updateDate,
	...
	public ProductCategoryDto(String id, Integer grade, String name,
	...
	public String toString(){
		   return "ProductCategory [id=" + id + ",createDate=" + createDate + ","
		   		+ "updateDate=" + updateDate + ",order=" + order + ","
		   		+ "grade=" + grade + ", name=" + name + ", seoDescription="
