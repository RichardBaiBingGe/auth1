...
public class AdSysPlanDto {
	 ...
	 * @param updateDate
	 */
	public AdSysPlanDto(String code, Date curDate, String resourceCode,
			String resourceName, Boolean lockStatus, EnableFlagType enableFlag,
