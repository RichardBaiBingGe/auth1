...
public class Order {
	...
	private Long admin;
	/** 售货机订单状态 */
	private Integer machineOrderStatus;
	/** 售货机 */
	...
	public Integer getOrderMaked() {
		return orderMaked;
	}

	public void setOrderMaked(Integer orderMaked) {
	...
	public Integer getMachineOrderStatus() {
		return machineOrderStatus;
	}

	public void setMachineOrderStatus(Integer machineOrderStatus) {
	...
	public Order(Long id, String address, BigDecimal amountPaid,
			...
			Integer orderMaked, Integer orderSource, String orderTime,
			Integer printCount, String shipperCode, String shipperName,
			Long admin, Integer machineOrderStatus, Long vendingMachine,
	...
	public Order(Long id, Date createDate, Date modifyDate, String address,
			BigDecimal amountPaid, String areaName, String consignee,
			BigDecimal couponDiscount, Date expire, BigDecimal fee,
			BigDecimal freight, String invoiceTitle, Integer isAllocatedStock,
			Integer isInvoice, Date lockExpire, String memo,
			BigDecimal offsetAmount, Integer orderStatus,
			String paymentMethodName, Integer paymentStatus, String phone,
			Long point, String promotion, BigDecimal promotionDiscount,
			String shippingMethodName, Integer shippingStatus, String sn,
			...
			String expireTime, Integer itemsSize, Integer orderMaked,
			Integer orderSource, String orderTime, Integer printCount,
			String shipperCode, String shipperName, Long admin,
			Integer machineOrderStatus, Long vendingMachine, Date paymentTime,
